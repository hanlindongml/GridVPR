...
ImageFile.LOAD_TRUNCATED_IMAGES = True  # 加载损坏图片
...
class TrainDataset(torch.utils.data.Dataset):
    def __init__(self, args, dataset_folder, M=10, alpha=30, N=5, L=2,
        ...
        filename = '/home/cache/database_scale[1,2]_orientation[-15,0,15]_phase[-2,0,2]_mips20.torch'  # Change your cache file name here
...
if __name__ == '__main__':
    ...
    TrainDataset(args, args.train_set_folder, M=args.M, alpha=args.alpha, N=args.N, L=args.L,
