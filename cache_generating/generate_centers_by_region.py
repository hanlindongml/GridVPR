...
def rotate_and_translate(Position_A, Position_B, angle_degrees, translation):
    ...
    translation_matrix = np.array([[1, 0, translation_X], [0, 1, translation_Y], [0, 0, 1]])  # 平移矩阵
    center_transformed = np.dot(translation_matrix[:2, :2], (B_X_prime, B_Y_prime)) + translation_matrix[:2, 2]  # 应用变换到原始图案的圆心
