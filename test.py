...
def test(args: Namespace, eval_ds: Dataset, model: torch.nn.Module,
    ...
    with torch.no_grad():
        ...
        database_dataloader = DataLoader(dataset=database_subset_ds, num_workers=args.val_num_workers,
        ...
        queries_dataloader = DataLoader(dataset=queries_subset_ds, num_workers=args.val_num_workers,
